...
import com.wugui.docs.exception.JavaFileNotFoundException;
import com.wugui.docs.parser.ClassNode;
import com.wugui.docs.parser.FieldNode;
import com.wugui.docs.parser.GenericNode;
import com.wugui.docs.parser.MockNode;
...
public class ParseUtils {
    ...
    static {
        ...
        typeMap.put("localdate", "date");
        typeMap.put("zoneddatetime", "date");
        typeMap.put("localdatetime", "date");
        typeMap.put("file", "file");
        typeMap.put("multipartfile", "file");
    ...
    public static String unifyType(String className){
        ...
        String type = typeMap.get(rawType);
        return StringUtils.isNotEmpty(type) ? type : TYPE_MODEL;
    }
